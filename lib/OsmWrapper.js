...
module.exports = class OsmEnvironment {
  ...
  constructor(lat, lon, latCoverage, lonCoverage, settings) {
    ...
    this.bounds = OsmEnvironment.getBounds(lat, lon, latCoverage, lonCoverage);
    this.viewport = OsmEnvironment.getViewport(settings);
    this.offset = {x: 0, y: 0};
  ...
  async init(elementInteractions, icons) {
